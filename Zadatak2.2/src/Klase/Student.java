...
public class Student {
    ...
    public Student(String ime, String prezime, Date datumRodjenja, String brojIndeksa, String odsjek, Integer godinaStudija) throws StudentBuducnostException, PremladStudentException {
        setIme(ime);
        setPrezime(prezime);
